...
[br, pe2(i)]=symerr(y2,Z2);             %对解调后大噪声信号误码分析（循环码编码，2fsk误码率分析）
...
%---------画出不同方式下信噪比与误码率关系------%
figure(5);
semilogy(SNR,pe1,'r--*');               % 调用semilogy函数绘制”汉明码编码2ask“信噪比与误码率的关系曲线
hold on
semilogy(SNR,pe2,'--');                 % 调用semilogy函数绘制“循环码编码2fsk”信噪比与误码率的关系曲线
semilogy(SNR,pe3,'c--+');               % 调用semilogy函数绘制”循环码编码2ask“信噪比与误码率的关系曲线
semilogy(SNR,pe4,'k--o');               % 调用semilogy函数绘制“汉明码编码2fsk”信噪比与误码率的关系曲线
hold off
